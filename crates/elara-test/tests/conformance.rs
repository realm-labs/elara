...
fn conformance_standard_library_fixtures() {
    ...
    assert_success_fixture(
        "stdlib/base_metatable_false_marker.lua",
        vec![
            Value::boolean(true),
            Value::boolean(false),
            Value::integer(115),
    ...
    assert_success_fixture(
        "stdlib/base_assert_scalar_message.lua",
    ...
    assert_success_fixture(
        "stdlib/base_assert_missing_condition.lua",
        vec![Value::boolean(false), Value::integer(115)],
    );
    assert_success_fixture(
    ...
    assert_success_fixture(
        "stdlib/base_tonumber_base_conversion.lua",
        vec![
            Value::integer(10),
            Value::integer(10),
            Value::boolean(false),
    ...
    assert_success_fixture(
        "stdlib/base_tostring_metamethod.lua",
        vec![
            Value::integer(99),
            Value::integer(6),
            Value::integer(42),
    ...
    assert_success_fixture(
        "stdlib/base_select_zero_position.lua",
        vec![Value::boolean(false), Value::integer(115)],
    );
    assert_success_fixture(
    ...
    assert_success_fixture(
        "stdlib/base_xpcall_missing_target.lua",
        vec![
            Value::boolean(false),
            Value::integer(115),
            Value::integer(115),
    ...
    assert_success_fixture(
        ...
        vec![Value::integer(115), Value::boolean(true)],
    );
    assert_success_fixture(
