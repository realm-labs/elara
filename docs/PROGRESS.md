...
M18.1 long-string base-library verification passed:

```bash
cargo fmt --all
cargo test -p elara-stdlib base_
cargo test -p elara-api base_functions_accept_long_strings
cargo fmt --all -- --check
