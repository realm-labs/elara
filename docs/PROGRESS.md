...
strings, allocate runtime-owned tables, and read/write raw runtime table array
...
evaluation. Table natives `table.insert`, `table.pack`, and `table.unpack` are
...
M11.2 executable table.insert verification passed:
