...
- The conformance coroutine smoke matrix now also includes wrap, resume success,
  and created-coroutine lifecycle status coverage.

## Remaining Gaps

### Release Conformance Dashboard

- `tests/conformance` currently contains forty-seven smoke fixtures across
...
Post-M20.4 math random fixture expansion passed:
...
| Conformance | Expanded post-M20.4 | Forty-seven smoke fixtures run through the public API with exact primitive return-value checks for success cases and error-class checks for failure cases; broader API/unit coverage exists, but release-sized conformance remains a product gap. |
