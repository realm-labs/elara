...
Continue M18.2 with `debug.getlocal`/`debug.setlocal` behavior while keeping
coroutine and JIT debug frame behavior explicit until hook/deopt integration is
designed.
