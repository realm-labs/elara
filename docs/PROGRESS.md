...
- `tests/conformance` currently contains twenty smoke fixtures across
...
Post-M20.4 language conformance fixture expansion passed:
...
| Conformance | Expanded post-M20.4 | Twenty smoke fixtures run through the public API with exact primitive return-value checks for success cases; broader API/unit coverage exists, but release-sized conformance remains a product gap. |
